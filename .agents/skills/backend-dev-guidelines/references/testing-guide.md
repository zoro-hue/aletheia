...
Complete guide to testing Aletheia backend services across web, worker, and shared packages.
...
Aletheia uses multiple testing strategies for different layers:
...
import { v4 } from "uuid";
import { JobConfigState } from "@aletheia/shared";
