...
### Aletheia Repository Examples

Use these current Aletheia files as repository templates:
...
Use `testing-guide.md` for backend test patterns. Prefer current Aletheia tests
