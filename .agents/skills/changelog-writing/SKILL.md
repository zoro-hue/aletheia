...
description: |
  Shared workflow for writing Aletheia changelog entries after a feature is complete.
...
2. Study recent changelog patterns in `../aletheia-docs/pages/changelog`.
3. Find related documentation links in `../aletheia-docs/pages`.
...
- Changelog destination: `../aletheia-docs/pages/changelog`
- Recent changelog examples: inspect 3-5 recent files in that directory
- Existing docs: `../aletheia-docs/pages`
