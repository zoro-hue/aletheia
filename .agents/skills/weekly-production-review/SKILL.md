...
description: |
  Prepare Aletheia weekly production reviews that audit what broke, what was
...
3. Gather incident.io alert load for the same review window. Prefer
   incident.io alert or escalation stats for the primary Aletheia escalation
...
Prefer incident.io alert or escalation stats filtered to the Aletheia escalation
