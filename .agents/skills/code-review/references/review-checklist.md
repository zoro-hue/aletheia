...
This is the canonical shared review checklist for Aletheia.
...
- When attempting to confirm if the current environment is Aletheia Cloud in the frontend, use the `useAletheiaCloudRegion` hook and never environment variables directly.
