...
const EVENTS_TABLE_READ_PATH_ENV_KEYS = [
  "ALETHEIA_ENABLE_EVENTS_TABLE_OBSERVATIONS",
  "ALETHEIA_ENABLE_EVENTS_TABLE_UI",
  "ALETHEIA_ENABLE_EVENTS_TABLE_FLAGS",
  "ALETHEIA_ENABLE_EVENTS_TABLE_V2_APIS",
  ...
  public getClient(
    ...
    if (!this.clientMap.has(key)) {
      ...
      const client = createClient({
        ...opts,
        ...settings,
        application: `aletheia/${VERSION.replace("v", "")}`,
        keep_alive: {
        ...
        log: {
          ...
          level: mapLogLevel(env.ALETHEIA_LOG_LEVEL ?? "info"),
        },
        clickhouse_settings: {
