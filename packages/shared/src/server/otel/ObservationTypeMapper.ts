...
type AletheiaObservationType = keyof typeof ObservationType;
...
class SimpleAttributeMapper implements ObservationTypeMapper {
  ...
  mapToObservationType(
    ...
    if (
      ...
      return mappedType as AletheiaObservationType;
    }
  ...
  private readonly mappers: ObservationTypeMapper[] = [
    ...
    new CustomAttributeMapper(
      ...
      (attributes, resourceAttributes, scopeData) => {
        return (
          attributes[AletheiaOtelSpanAttributes.OBSERVATION_TYPE] === "span" &&
          scopeData?.name === "aletheia-sdk" &&
    ...
    // Priority 1: maps aletheia.observation.type directly
    new SimpleAttributeMapper(
      "AletheiaObservationTypeDirectMapping",
      1,
      AletheiaOtelSpanAttributes.OBSERVATION_TYPE,
      {
        span: "SPAN",
    ...
    new SimpleAttributeMapper("OpenInference", 2, "openinference.span.kind", {
      // Format:
      // OpenInference Value: Aletheia ObservationType
      CHAIN: "CHAIN",
      RETRIEVER: "RETRIEVER",
      LLM: "GENERATION",
      EMBEDDING: "EMBEDDING",
    ...
    new SimpleAttributeMapper(
      ...
      {
        // Format:
        // GenAI Value: Aletheia ObservationType
        chat: "GENERATION",
    ...
    new SimpleAttributeMapper("Genkit", 4, "genkit:metadata:subtype", {
      // Format:
      // Genkit Value: Aletheia ObservationType
    ...
    new CustomAttributeMapper(
      ...
      (attributes) => {
        ...
        const prefixMappings: Array<[string[], AletheiaObservationType]> = [
          [
            [
              "ai.generateText.doGenerate",
              "ai.streamText.doStream",
