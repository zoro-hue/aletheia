...
export const getScoresForAnalyticsIntegrations = async function* (
  ...
  for await (const record of records) {
    ...
    yield {
      ...
      aletheia_score_name: record.name,
      aletheia_score_value: record.value,
      aletheia_score_comment: record.comment,
      aletheia_score_metadata: record.metadata,
      aletheia_score_string_value: record.string_value,
      aletheia_score_data_type: record.data_type,
      aletheia_trace_name: record.trace_name,
      aletheia_trace_id: effectiveTraceId,
      ...
      aletheia_session_id: effectiveSessionId,
      ...
      aletheia_score_entity_type: record.score_trace_id
        ? "trace"
        : record.score_session_id
          ...
          : record.score_dataset_run_id
            ? "dataset_run"
            : "unknown",
      aletheia_dataset_run_id: record.score_dataset_run_id,
