...
export class DashboardService {
  ...
  public static async listDashboards(props: {
    ...
    const domainDashboards = dashboards.map((dashboard) =>
      DashboardDomainSchema.parse({
        ...dashboard,
        owner: dashboard.projectId ? "PROJECT" : "ALETHEIA",
      }),
    );
  ...
  public static async createDashboard(
    ...
    return DashboardDomainSchema.parse({
      ...newDashboard,
      owner: newDashboard.projectId ? "PROJECT" : "ALETHEIA",
    });
  }
  ...
  public static async updateDashboardDefinition(
    ...
    return DashboardDomainSchema.parse({
      ...updatedDashboard,
      owner: updatedDashboard.projectId ? "PROJECT" : "ALETHEIA",
    });
  }
  ...
  public static async listWidgets(props: {
    ...
    const domainWidgets = widgets.map((widget) =>
      WidgetDomainSchema.parse({
        ...widget,
        owner: widget.projectId ? "PROJECT" : "ALETHEIA",
      }),
    );
  ...
  public static async createWidget(
    ...
    return WidgetDomainSchema.parse({
      ...newWidget,
      owner: newWidget.projectId ? "PROJECT" : "ALETHEIA",
    });
  }

  /**
   * Gets a dashboard widget by ID. Look either in the current project or in the Aletheia managed widgets.
   */
  ...
  public static async updateWidget(
    ...
    return WidgetDomainSchema.parse({
      ...updatedWidget,
      owner: updatedWidget.projectId ? "PROJECT" : "ALETHEIA",
    });
  }
  ...
  public static async deleteWidget(
    ...
    if (referencingDashboards.length > 0) {
      ...
      throw new AletheiaConflictError(
  ...
  /**
   * Copies a Aletheia-owned widget into the user project, rewires the specified dashboard placement to the new widget and returns the new widget id.
   */
