...
const ResetPasswordTemplate = ({
  ...
  const previewText = isSetupMode
    ? "Verify your Aletheia email"
    : "Your Aletheia reset code";
  return (
    <Html>
      <Head />
