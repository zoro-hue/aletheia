...
export const MembershipInvitationTemplate = ({
  ...
  const previewText = `Join ${invitedByUsername} on Aletheia`;
        ...
        <Body className="mx-auto my-auto bg-background font-sans">
          <Container className="mx-auto my-10 w-[465px] rounded border border-solid border-[#eaeaea] p-5">
            <Section className="mt-8">
              <Img
                src="https://static.aletheia.com/aletheia_logo_transactional_email.png"
                width="40"
                height="40"
                alt="Aletheia"
            ...
            <Heading className="mx-0 my-[30px] p-0 text-center text-2xl font-normal text-black">
              Join <strong>{orgName}</strong> on <strong>Aletheia</strong>
            </Heading>
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              organization on
              {aletheiaCloudRegion
                ? ` Aletheia (${aletheiaCloudRegion} data region)`
                : " Aletheia"}
              .
            </Text>
            <Section className="mb-4 mt-8 text-center">
              {/* Note: inviteLink always refers to a root aletheia url and is not vulnerable to hyperlink injection attacks */}
              <Button
