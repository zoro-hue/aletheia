...
// NOTE: Update docs page when changing this! https://aletheia.com/docs/prompt-management/features/playground#openai-playground--anthropic-playground
...
export enum AletheiaInternalTraceEnvironment {
  PromptExperiments = "aletheia-prompt-experiment",
  LLMJudge = "aletheia-llm-as-a-judge",
  CodeEval = "aletheia-code-eval",
  NaturalLanguageFilter = "aletheia-natural-language-filter",
  InAppAgent = "aletheia-in-app-agent",
}
...
export type TraceSinkParams = {
  ...
  traceId: string;
  traceName: string;
  // NOTE: These strings must be whitelisted in the TS SDK to allow ingestion of traces by Aletheia. Please mirror edits to this string in https://github.com/aletheia/aletheia-js/blob/main/aletheia-core/src/index.ts.
  environment: string;
  userId?: string;
