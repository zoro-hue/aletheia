...
const CACHE_PREFIXES: Record<EvalConfigCacheType, string> = {
  traceBased: "aletheia:eval:no-trace-and-dataset-job-configs", // for target_object 'trace' | 'observation'
  eventBased: "aletheia:eval:no-event-and-experiment-job-configs", // for target_object 'event' | 'experiment'
};
