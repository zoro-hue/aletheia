...
const mockMonitorAlert: MonitorAlert = {
  monitorId: "mon_01",
  projectId: "proj_01",
  permalink: "https://cloud.aletheia.com/project/proj_01/monitors/mon_01",
  message: {
...
describe("buildMonitorAlertSlackMessage", () => {
  it("ALERT: red attachment; linked title; body mrkdwn; timestamp; neutral view button", () => {
    ...
    expect(inner[0]).toMatchObject({
      ...
      text: {
        type: "mrkdwn",
        text: "*<https://cloud.aletheia.com/project/proj_01/monitors/mon_01|High error rate>*",
      },
    });
    ...
    expect(inner[3].elements[0]).toMatchObject({
      type: "button",
      url: "https://cloud.aletheia.com/project/proj_01/monitors/mon_01",
    });
  ...
  it("title links to the permalink", () => {
    ...
    expect(attachments![0].blocks![0].text.text).toBe(
      "*<https://cloud.aletheia.com/project/proj_01/monitors/mon_01|High error rate>*",
    );
  });
