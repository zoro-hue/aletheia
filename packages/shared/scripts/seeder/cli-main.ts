/**
 * Aletheia seed CLI — one-shot local test data for humans and coding agents.
 *
 * Usage:
...
const COMMON_FLAGS: ScenarioFlag[] = [
  ...
  },
  {
    ...
    type: "string",
    default: "default",
    description: "aletheia environment written on rows",
  },
  {
    flag: "seed",
    type: "number",
...
const usage = (): string => {
  const lines = [
    "Aletheia seed CLI — one-shot local test data.",
    "",
    "Usage:",
