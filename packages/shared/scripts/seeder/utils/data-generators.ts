 ...
 * - generateDatasetTrace(): For dataset experiment runs (aletheia-prompt-experiment env)
 * - generateEvaluationTraces(): For evaluation data (aletheia-evaluation env)
...
export class DataGenerator {
  ...
  generateDatasetTrace(
    ...
    return createTrace({
      ...
      input: traceInput,
      output: traceOutput,
      environment: "aletheia-prompt-experiment",
      metadata: { experimentType: "aletheia-prompt-experiment" },
      public: false,
      bookmarked: false,
      session_id: null,
      tags: [],
          ...
          const observation: ObservationRecordInsertType = createObservation({
            ...
            provided_cost_details:
              obsType === "GENERATION"
                ...
                : undefined,
            environment: "aletheia-evaluation",
          });
