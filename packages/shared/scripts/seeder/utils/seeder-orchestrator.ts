 ...
 * - createDatasetExperimentData(): Dataset runs in aletheia-prompt-experiment env
 * - createEvaluationData(): Evaluation data in aletheia-evaluation env
          ...
          output: JSON.stringify([
            {
              role: "assistant",
              content:
                "I can see the Aletheia logo in the image. The trace also includes a PDF attachment on the output field and an audio attachment on the metadata field. Check the trace metadata for the deterministic media IDs and reference strings.",
            },
          ]),
          metadata: {
            message:
