...
})(AletheiaPersistedProperty || (AletheiaPersistedProperty = {}));
var ChatMessageType;
...
class AletheiaCoreStateless {
  ...
  async processEnqueueEvent(type, body) {
    ...
    const queue = this.getPersistedProperty(AletheiaPersistedProperty.Queue) || [];
    queue.push({
      id: generateUUID(),
      type,
    ...
    this.setPersistedProperty(AletheiaPersistedProperty.Queue, queue);
  ...
  flush(callback) {
    ...
    this.setPersistedProperty(AletheiaPersistedProperty.Queue, [...remainingItems, ...queue]);
...
export { ChatMessageType, ChatPromptClient, AletheiaCore, AletheiaEventClient, AletheiaGenerationClient, AletheiaMedia, AletheiaMemoryStorage, AletheiaObjectClient, AletheiaPersistedProperty, AletheiaSpanClient, AletheiaTraceClient, AletheiaWebStateless, TextPromptClient, utils };
