...
var aletheiaCore = require('aletheia-core');
...
class Aletheia extends aletheiaCore.AletheiaCore {
  constructor(params) {
    const aletheiaConfig = aletheiaCore.utils.configAletheiaSDK(params);
...
class AletheiaWeb extends aletheiaCore.AletheiaWebStateless {
  constructor(params) {
    const aletheiaConfig = aletheiaCore.utils.configAletheiaSDK(params, false);
    super(aletheiaConfig);
...
Object.defineProperty(exports, "AletheiaMedia", {
  enumerable: true,
  get: function () { return aletheiaCore.AletheiaMedia; }
});
exports.Aletheia = Aletheia;
exports.AletheiaWeb = AletheiaWeb;
exports.default = Aletheia;
