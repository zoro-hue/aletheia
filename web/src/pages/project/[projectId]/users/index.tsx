...
import { type FilterState, usersTableCols } from "@aletheia/shared";
    ...
    <Page
      headerProps={{
        ...
        help: {
          description: (
            <>
              Attribute data in Aletheia to a user by adding a userId to your
              traces. See{" "}
              <a
...
const UsersTable = ({ isBetaEnabled }: { isBetaEnabled: boolean }) => {
  ...
  const columns: AletheiaColumnDef<RowData>[] = [
    {
      accessorKey: "userId",
      ...
      headerTooltip: {
        description:
          "The unique identifier for the user that was logged in Aletheia. See docs for more details on how to set this up.",
        href: "https://aletheia.com/docs/observability/features/users",
      },
      size: 150,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      headerTooltip: {
        ...
        href: "https://aletheia.com/docs/observability/data-model",
      },
      size: 120,
      loadingCell: <TableTextLoadingCell />,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      headerTooltip: {
        ...
        href: "https://aletheia.com/docs/model-usage-and-cost",
      },
      size: 120,
      loadingCell: <TableTextLoadingCell />,
      cell: ({ row }) => {
