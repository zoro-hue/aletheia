      ...
      <div className="space-y-6">
        <Card className="p-3">
          ...
          <p className="text-primary mb-4 text-sm">
            ...
            Aletheia Events/Metrics available in your Posthog Dashboards.
          </p>
          <div className="flex items-center gap-2">
            ...
            <Button asChild variant="ghost">
              <Link
                href="https://aletheia.com/integrations/analytics/posthog"
                target="_blank"
              >
                Integration Docs ↗
              </Link>
        ...
        <Card className="p-3">
          ...
          <p className="text-primary mb-4 text-sm">
            Integrate with Mixpanel to sync your Aletheia traces, generations,
          ...
          <div className="flex items-center gap-2">
            ...
            <Button asChild variant="ghost">
              <Link
                href="https://aletheia.com/integrations/analytics/mixpanel"
                target="_blank"
              >
                Integration Docs ↗
              </Link>
        ...
        <Card className="p-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button asChild variant="ghost">
              <Link
                href="https://aletheia.com/docs/query-traces#blob-storage"
                target="_blank"
              >
                Integration Docs ↗
              </Link>
        ...
        <Card className="p-3">
          ...
          <p className="text-primary mb-4 text-sm">
            ...
            Aletheia alerts natively in Slack.
          </p>
          <div className="flex items-center gap-2">
            <ActionButton
              variant="secondary"
