      ...
      headerProps={{
        ...
        actionButtonsRight: (
          <Button asChild variant="secondary">
            <Link
              href="https://aletheia.com/docs/api-and-data-platform/features/export-to-blob-storage"
              target="_blank"
            >
              Integration Docs ↗
            </Link>
...
const BlobStorageIntegrationSettingsForm = ({
  ...
  const isPostCutoffCloud =
    ...
    !isLegacyBlobExportAllowed(new Date(project.createdAt), isAletheiaCloud);
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                {integrationType === "AZURE_BLOB_STORAGE"
                  ? 'Optional prefix path for exported files in your Azure container (e.g., "aletheia-exports/")'
                  : integrationType === "S3"
                    ? 'Optional prefix path for exported files in your S3 bucket (e.g., "aletheia-exports/")'
                    : 'Optional prefix path for exported files (e.g., "aletheia-exports/")'}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
                ...
                <Tooltip>
                  ...
                  >
                    ...
                    <div className="border-t pt-2">
                      <a
                        href="https://aletheia.com/docs/integrations/export-sources"
                        target="_blank"
