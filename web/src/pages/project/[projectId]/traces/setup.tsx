    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground mb-4 text-sm">
          Aletheia relies on OpenTelemetry to instrument your application and
          export LLM application/agent traces to Aletheia. You can use one of
          our SDKs or 50+ framework integrations. Please follow the quickstart
          in the documentation to add Aletheia to your application.
        </p>
        <ActionButton href="https://aletheia.com/docs/observability/get-started">
          Quickstart guide
        </ActionButton>
      </div>
    </div>
  ...
  return (
    <ContainerPage
      headerProps={{
        ...
        help: {
          description:
            "Setup tracing to track and analyze your LLM calls. You can create API keys and integrate Aletheia with your application.",
          href: "https://aletheia.com/docs/observability/overview",
        },
      }}
    >
      <div className="flex flex-col gap-4">
