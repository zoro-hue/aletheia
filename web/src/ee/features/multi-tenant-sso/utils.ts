...
import { type SsoConfig, prisma } from "@aletheia/shared/src/db";
 ...
 */
export async function loadSsoProviders(): Promise<any[]> {
  if (!multiTenantSsoAvailable) return [];
 ...
 */
const dbToNextAuthProvider = (provider: SsoProviderSchema): any | null => {
