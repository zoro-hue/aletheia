...
import { BatchExportTableName } from "@aletheia/shared";
...
export function AuditLogsTable(props: AuditLogsTableProps) {
  ...
  const columns: AletheiaColumnDef<AuditLogRow>[] = [
    {
    ...
    },
    {
      ...
      header: "Actor",
      headerTooltip: {
        description: "The actor within Aletheia who performed the action.",
      },
      cell: (row) => {
