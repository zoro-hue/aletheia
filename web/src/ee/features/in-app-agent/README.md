...
The in-app agent is Aletheia's project-scoped foreground assistant inside the authenticated product UI.
...
- `server/instrumentation.ts`: optional Aletheia tracing for agent runs, prompts, events, and errors.
