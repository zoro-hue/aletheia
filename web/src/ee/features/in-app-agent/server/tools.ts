...
import { ObservationLevelDomain, TracingSearchType } from "@aletheia/shared";
...
export function createRedirectActionTool({
  ...
  return createTool({
    ...
    description:
      "Propose a user-confirmed navigation action to a known Aletheia page. This does not navigate automatically.",
