...
const streamingInvestigations = [
  ...
  },
  {
    ...
    toolName: "aletheia_queryMetrics",
    toolArgs: {
      view: "scores",
  ...
  },
  {
    ...
    toolName: "aletheia_getObservations",
    toolArgs: {
      ...
      },
      {
        ...
        content: {
          ...
          text: [
            ...
            "###### Heading 6",
            "",
            "You can use **Aletheia** to inspect _production traces_ and compare `input`, `output`, and metadata across releases.",
            "",
      ...
      },
      {
        ...
        content: {
          ...
          tools: [
            {
              type: "tool",
              name: "aletheia_getObservationFilterValues",
              args: JSON.stringify({
                column: "providedModelName",
                limit: 50,
