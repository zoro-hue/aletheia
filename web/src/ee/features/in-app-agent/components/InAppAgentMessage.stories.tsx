...
export const AssistantText = meta.story({
  args: {
    ...
    content: {
      type: "text",
      text: "Aletheia tracks traces, observations, scores, and metadata so teams can debug LLM applications.",
    },
  },
});
...
export const AssistantTextWithSources = meta.story({
  args: {
    ...
    content: {
      type: "text" as const,
      text: "Scores are Aletheia's universal data object for storing evaluation results.",
      sources: [
        {
          title: "Scores",
        ...
        },
        {
          ...
          url: "https://aletheia.com/docs/evaluation/scores/data-model",
          faviconUrl: "https://aletheia.com/favicon.ico",
        },
      ],
    },
  ...
  args: {
    ...
    content: {
      ...
      text: [
        ...
        "###### Heading 6",
        "",
        "You can use **Aletheia** to inspect _production traces_ and compare `input`, `output`, `metadata` and `scores` across releases.",
        "",
