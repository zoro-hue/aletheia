...
const SELECTED_CONVERSATION_STORAGE_KEY_PREFIX =
  "aletheia:in-app-ai-agent-selected-conversation";
const OPEN_STORAGE_KEY_PREFIX = "aletheia:in-app-ai-agent-open";
const FEEDBACK_STORAGE_KEY_PREFIX = "aletheia:in-app-ai-agent-feedback";
