...
const CONVERSATION_STARTERS = [
  [
    ...
    "Where should I start with setting up Aletheia?",
  ],
  ["Optimize my setup", "What should I improve in my Aletheia setup?"],
  [
            ...
            {!hasUserMessage ? (
              <div className="flex h-full w-full flex-1 flex-col items-center justify-center px-2">
                ...
                <p className="text-muted-foreground mt-4 text-sm">
                  Welcome to the Aletheia Assistant
                </p>
                <p className="text-muted-foreground/60 mt-2 max-w-xs text-center text-sm leading-relaxed">
                  I can help you with any questions you have about Aletheia or
