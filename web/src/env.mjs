...
export const env = createEnv({
  ...
  server: {
    ...
    ALETHEIA_TEAM_SLACK_WEBHOOK: z.url().optional(),
    ALETHEIA_NEW_USER_SIGNUP_WEBHOOK: z.url().optional(),
    ALETHEIA_ADMIN_ACCESS_WEBHOOK: z.url().optional(),
    // Add `.min(1) on ID and SECRET if you want to make sure they're not empty
    ALETHEIA_ENABLE_EXPERIMENTAL_FEATURES: z.enum(["true", "false"]).optional(),
    SALT: z.string({
      error: (issue) =>
        issue.input === undefined
          ? "A strong Salt is required to encrypt API keys securely. See: https://aletheia.com/self-hosting#deploy-the-container"
          : "Invalid type",
    }),
    ...
    ALETHEIA_DEFAULT_ORG_ROLE: z
      .enum(["OWNER", "ADMIN", "MEMBER", "VIEWER", "NONE"])
      .optional(),
    ALETHEIA_DEFAULT_PROJECT_ID: z
      .string()
      .optional()
      .transform((val) =>
        val
    ...
    ALETHEIA_DEFAULT_PROJECT_ROLE: z
      .enum(["OWNER", "ADMIN", "MEMBER", "VIEWER"])
      .optional(),
    ALETHEIA_CSP_ENFORCE_HTTPS: z
      .enum(["true", "false"])
      .optional()
      .default("false"),
    // Telemetry
    ...
    // Aletheia Cloud only: "Sign in with ClickHouse Cloud" (Auth0 under the hood).
    // NOT intended for self-hosted Aletheia — use AUTH_AUTH0_* instead.
    ...
    // OTel Masking
    ALETHEIA_INGESTION_MASKING_PROPAGATED_HEADERS: z
      .string()
      .optional()
      .transform((s) =>
    ...
    // EE ui customization
    ALETHEIA_UI_API_HOST: z.string().optional(),
    ALETHEIA_UI_DOCUMENTATION_HREF: z.url().optional(),
    ALETHEIA_UI_SUPPORT_HREF: z.url().optional(),
    ALETHEIA_UI_FEEDBACK_HREF: z.url().optional(),
    ALETHEIA_UI_LOGO_LIGHT_MODE_HREF: z.url().optional(),
    ALETHEIA_UI_LOGO_DARK_MODE_HREF: z.url().optional(),
    ALETHEIA_UI_DEFAULT_MODEL_ADAPTER: z
      .enum(["OpenAI", "Anthropic", "Azure"])
      .optional(),
    ALETHEIA_UI_DEFAULT_BASE_URL_OPENAI: z.url().optional(),
    ALETHEIA_UI_DEFAULT_BASE_URL_ANTHROPIC: z.url().optional(),
    ALETHEIA_UI_DEFAULT_BASE_URL_AZURE: z.url().optional(),
    ...
    // aletheia caching
    ALETHEIA_CACHE_API_KEY_ENABLED: z.enum(["true", "false"]).default("true"),
    ALETHEIA_CACHE_API_KEY_TTL_SECONDS: z.coerce.number().default(300),

    // Multimodal media upload to S3
    ALETHEIA_S3_MEDIA_MAX_CONTENT_LENGTH: z.coerce
      .number()
      .positive()
      .int()
    ...
    ALETHEIA_S3_MEDIA_UPLOAD_FORCE_PATH_STYLE: z
      .enum(["true", "false"])
      .default("false"),
    ALETHEIA_S3_MEDIA_DOWNLOAD_URL_EXPIRY_SECONDS: z.coerce
      .number()
      .nonnegative()
      .default(3600),
    ...
    ALETHEIA_ALLOWED_ORGANIZATION_CREATORS: z
      .string()
      .optional()
      .refine((value) => {
      ...
      }, "ALETHEIA_ALLOWED_ORGANIZATION_CREATORS must be a comma separated list of valid email addresses"),

    STRIPE_SECRET_KEY: z.string().optional(),
    STRIPE_WEBHOOK_SIGNING_SECRET: z.string().optional(),
    SENTRY_AUTH_TOKEN: z.string().optional(),
    SENTRY_CSP_REPORT_URI: z.string().optional(),
    ALETHEIA_RATE_LIMITS_ENABLED: z.enum(["true", "false"]).default("true"),

    ALETHEIA_INIT_ORG_ID: z.string().optional(),
    ALETHEIA_INIT_ORG_NAME: z.string().optional(),
    ALETHEIA_INIT_ORG_CLOUD_PLAN: z.string().optional(), // for use in CI
    ALETHEIA_INIT_PROJECT_ID: z.string().optional(),
    ALETHEIA_INIT_PROJECT_NAME: z.string().optional(),
    ALETHEIA_INIT_PROJECT_RETENTION: z.coerce.number().int().gte(3).optional(),
    ALETHEIA_INIT_PROJECT_PUBLIC_KEY: z.string().optional(),
    ALETHEIA_INIT_PROJECT_SECRET_KEY: z.string().optional(),
    ALETHEIA_INIT_USER_EMAIL: z
      .union([z.email(), z.string().length(0)])
      .optional(),
    ALETHEIA_INIT_USER_NAME: z.string().optional(),
    ALETHEIA_INIT_USER_PASSWORD: z.string().optional(),
    ...
    ALETHEIA_UI_VISIBLE_PRODUCT_MODULES: z.string().optional(),
    // UI customization - comma-separated list of hidden product modules
    ALETHEIA_UI_HIDDEN_PRODUCT_MODULES: z.string().optional(),

    SLACK_CLIENT_ID: z.string().optional(),
    SLACK_CLIENT_SECRET: z.string().optional(),
    SLACK_STATE_SECRET: z.string().optional(),

    // AWS Bedrock for aletheia native AI feature such as natural language filters
    ALETHEIA_AWS_BEDROCK_MODEL: z.string().optional(),

    // Tracing for Aletheia AI Features
    ALETHEIA_AI_FEATURES_HOST: z.string().optional(),

    // Natural Aletheia Filters
    ALETHEIA_AI_FEATURES_PUBLIC_KEY: z.string().optional(),
    ALETHEIA_AI_FEATURES_SECRET_KEY: z.string().optional(),
    ALETHEIA_AI_FEATURES_PROJECT_ID: z.string().optional(),
    ...
    ALETHEIA_SKIP_FINAL_FOR_OTEL_PROJECTS: z
      .enum(["true", "false"])
      .default("false"),
    // API Traces endpoint controls (may induce breaking changes on API when changed!)
    ALETHEIA_API_TRACES_DEFAULT_DATE_RANGE_DAYS: z.coerce
      .number()
      .int()
      .positive()
      .optional(),
    ALETHEIA_API_TRACES_REJECT_NO_DATE_RANGE: z
      .enum(["true", "false"])
      .default("false"),
    ALETHEIA_API_TRACES_DEFAULT_FIELDS: z.string().optional(),
    ALETHEIA_API_TRACEBYID_DEFAULT_FIELDS: z.string().optional(),
    ...
    ALETHEIA_DISABLE_LEGACY_TRACING_IO_SEARCH: z
      .enum(["true", "false"])
      .default("false"),
    ...
    ALETHEIA_OBSERVATIONS_V2_SUBQUERY_REWRITE: z
      .enum(["true", "false"])
      .default("false"),
    ALETHEIA_OBSERVATIONS_V2_SHADOW_QUERY: z
      .enum(["true", "false"])
      .default("false"),
    ALETHEIA_OBSERVATIONS_V2_SHADOW_QUERY_SAMPLE_RATE: z.coerce
      .number()
      .min(0)
      .max(1)
      .default(0.01),
    ...
    ALETHEIA_BLOCKED_USERIDS_CHATCOMPLETION: z
      .string()
      .optional()
      .transform((val) => {
    ...
    ALETHEIA_AWS_BEDROCK_REGION: z.string().optional(),
    ALETHEIA_IN_APP_AGENT_AWS_PROFILE: z.string().optional(),
  },
  ...
  client: {
    ...
    NEXT_PUBLIC_ALETHEIA_CLOUD_REGION: z
      ...
      .optional(),
    NEXT_PUBLIC_ALETHEIA_BLOB_EXPORT_CUTOFF: z.iso.datetime().optional(),
    NEXT_PUBLIC_ALETHEIA_BLOB_EXPORTER_CUTOFF: z.iso.datetime().optional(),
    ...
    NEXT_PUBLIC_ALETHEIA_PLAYGROUND_STREAMING_ENABLED_DEFAULT: z
      .enum(["true", "false"])
      .optional()
      .default("true"),
  },
  ...
  runtimeEnv: {
    ...
    ALETHEIA_MCP_ALLOWED_HOSTS: process.env.ALETHEIA_MCP_ALLOWED_HOSTS,
    NEXT_PUBLIC_ALETHEIA_CLOUD_REGION:
      process.env.NEXT_PUBLIC_ALETHEIA_CLOUD_REGION,
    NEXT_PUBLIC_ALETHEIA_BLOB_EXPORT_CUTOFF:
      process.env.NEXT_PUBLIC_ALETHEIA_BLOB_EXPORT_CUTOFF,
    NEXT_PUBLIC_ALETHEIA_BLOB_EXPORTER_CUTOFF:
      process.env.NEXT_PUBLIC_ALETHEIA_BLOB_EXPORTER_CUTOFF,
    NEXT_PUBLIC_SIGN_UP_DISABLED: process.env.NEXT_PUBLIC_SIGN_UP_DISABLED,
    ALETHEIA_ENABLE_EXPERIMENTAL_FEATURES:
      process.env.ALETHEIA_ENABLE_EXPERIMENTAL_FEATURES,
    AWS_ACCESS_KEY_ID: process.env.AWS_ACCESS_KEY_ID,
    AWS_SECRET_ACCESS_KEY: process.env.AWS_SECRET_ACCESS_KEY,
    ALETHEIA_AWS_BEDROCK_REGION: process.env.ALETHEIA_AWS_BEDROCK_REGION,
    ALETHEIA_IN_APP_AGENT_AWS_PROFILE:
      process.env.ALETHEIA_IN_APP_AGENT_AWS_PROFILE,
    ALETHEIA_TEAM_SLACK_WEBHOOK: process.env.ALETHEIA_TEAM_SLACK_WEBHOOK,
    ALETHEIA_NEW_USER_SIGNUP_WEBHOOK:
      process.env.ALETHEIA_NEW_USER_SIGNUP_WEBHOOK,
    ALETHEIA_ADMIN_ACCESS_WEBHOOK: process.env.ALETHEIA_ADMIN_ACCESS_WEBHOOK,
    SALT: process.env.SALT,
    ALETHEIA_CSP_ENFORCE_HTTPS: process.env.ALETHEIA_CSP_ENFORCE_HTTPS,
    TELEMETRY_ENABLED: process.env.TELEMETRY_ENABLED,
    // Default org, project and role
    ALETHEIA_DEFAULT_ORG_ID: process.env.ALETHEIA_DEFAULT_ORG_ID,
    ALETHEIA_DEFAULT_ORG_ROLE: process.env.ALETHEIA_DEFAULT_ORG_ROLE,
    ALETHEIA_DEFAULT_PROJECT_ID: process.env.ALETHEIA_DEFAULT_PROJECT_ID,
    ALETHEIA_DEFAULT_PROJECT_ROLE: process.env.ALETHEIA_DEFAULT_PROJECT_ROLE,
    // AUTH
    ...
    ALETHEIA_INGESTION_MASKING_PROPAGATED_HEADERS:
      process.env.ALETHEIA_INGESTION_MASKING_PROPAGATED_HEADERS,

    // S3 media upload
    ALETHEIA_S3_MEDIA_MAX_CONTENT_LENGTH:
      process.env.ALETHEIA_S3_MEDIA_MAX_CONTENT_LENGTH,
    ALETHEIA_S3_MEDIA_UPLOAD_BUCKET:
      process.env.ALETHEIA_S3_MEDIA_UPLOAD_BUCKET,
    ALETHEIA_S3_MEDIA_UPLOAD_PREFIX:
      process.env.ALETHEIA_S3_MEDIA_UPLOAD_PREFIX,
    ALETHEIA_S3_MEDIA_UPLOAD_REGION:
      process.env.ALETHEIA_S3_MEDIA_UPLOAD_REGION,
    ALETHEIA_S3_MEDIA_UPLOAD_ENDPOINT:
      process.env.ALETHEIA_S3_MEDIA_UPLOAD_ENDPOINT,
    ALETHEIA_S3_MEDIA_UPLOAD_ACCESS_KEY_ID:
      process.env.ALETHEIA_S3_MEDIA_UPLOAD_ACCESS_KEY_ID,
    ALETHEIA_S3_MEDIA_UPLOAD_SECRET_ACCESS_KEY:
      process.env.ALETHEIA_S3_MEDIA_UPLOAD_SECRET_ACCESS_KEY,
    ALETHEIA_S3_MEDIA_UPLOAD_FORCE_PATH_STYLE:
      process.env.ALETHEIA_S3_MEDIA_UPLOAD_FORCE_PATH_STYLE,
    ALETHEIA_S3_MEDIA_DOWNLOAD_URL_EXPIRY_SECONDS:
      process.env.ALETHEIA_S3_MEDIA_DOWNLOAD_URL_EXPIRY_SECONDS,
    ALETHEIA_S3_MEDIA_UPLOAD_SSE: process.env.ALETHEIA_S3_MEDIA_UPLOAD_SSE,
    ALETHEIA_S3_MEDIA_UPLOAD_SSE_KMS_KEY_ID:
      process.env.ALETHEIA_S3_MEDIA_UPLOAD_SSE_KMS_KEY_ID,
    // Worker
    ...
    // EE ui customization
    ALETHEIA_UI_API_HOST: process.env.ALETHEIA_UI_API_HOST,
    ALETHEIA_UI_DOCUMENTATION_HREF: process.env.ALETHEIA_UI_DOCUMENTATION_HREF,
    ALETHEIA_UI_SUPPORT_HREF: process.env.ALETHEIA_UI_SUPPORT_HREF,
    ALETHEIA_UI_FEEDBACK_HREF: process.env.ALETHEIA_UI_FEEDBACK_HREF,
    ALETHEIA_UI_LOGO_LIGHT_MODE_HREF:
      process.env.ALETHEIA_UI_LOGO_LIGHT_MODE_HREF,
    ALETHEIA_UI_LOGO_DARK_MODE_HREF:
      process.env.ALETHEIA_UI_LOGO_DARK_MODE_HREF,
    ALETHEIA_UI_DEFAULT_MODEL_ADAPTER:
      process.env.ALETHEIA_UI_DEFAULT_MODEL_ADAPTER,
    ALETHEIA_UI_DEFAULT_BASE_URL_OPENAI:
      process.env.ALETHEIA_UI_DEFAULT_BASE_URL_OPENAI,
    ALETHEIA_UI_DEFAULT_BASE_URL_ANTHROPIC:
      process.env.ALETHEIA_UI_DEFAULT_BASE_URL_ANTHROPIC,
    ALETHEIA_UI_DEFAULT_BASE_URL_AZURE:
      process.env.ALETHEIA_UI_DEFAULT_BASE_URL_AZURE,
    ALETHEIA_UI_VISIBLE_PRODUCT_MODULES:
      process.env.ALETHEIA_UI_VISIBLE_PRODUCT_MODULES,
    ALETHEIA_UI_HIDDEN_PRODUCT_MODULES:
      process.env.ALETHEIA_UI_HIDDEN_PRODUCT_MODULES,
    // Playground
    NEXT_PUBLIC_ALETHEIA_PLAYGROUND_STREAMING_ENABLED_DEFAULT:
      process.env.NEXT_PUBLIC_ALETHEIA_PLAYGROUND_STREAMING_ENABLED_DEFAULT,
    // EE License
    ALETHEIA_EE_LICENSE_KEY: process.env.ALETHEIA_EE_LICENSE_KEY,
    ADMIN_API_KEY: process.env.ADMIN_API_KEY,
    ENCRYPTION_KEY: process.env.ENCRYPTION_KEY,
    // aletheia caching
    ALETHEIA_CACHE_API_KEY_ENABLED: process.env.ALETHEIA_CACHE_API_KEY_ENABLED,
    ALETHEIA_CACHE_API_KEY_TTL_SECONDS:
      process.env.ALETHEIA_CACHE_API_KEY_TTL_SECONDS,
    ALETHEIA_ALLOWED_ORGANIZATION_CREATORS:
      process.env.ALETHEIA_ALLOWED_ORGANIZATION_CREATORS,
    STRIPE_SECRET_KEY: process.env.STRIPE_SECRET_KEY,
    STRIPE_WEBHOOK_SIGNING_SECRET: process.env.STRIPE_WEBHOOK_SIGNING_SECRET,
    SENTRY_AUTH_TOKEN: process.env.SENTRY_AUTH_TOKEN,
    SENTRY_CSP_REPORT_URI: process.env.SENTRY_CSP_REPORT_URI,
    ALETHEIA_RATE_LIMITS_ENABLED: process.env.ALETHEIA_RATE_LIMITS_ENABLED,
    // provisioning
    ALETHEIA_INIT_ORG_ID: process.env.ALETHEIA_INIT_ORG_ID,
    ALETHEIA_INIT_ORG_NAME: process.env.ALETHEIA_INIT_ORG_NAME,
    ALETHEIA_INIT_ORG_CLOUD_PLAN: process.env.ALETHEIA_INIT_ORG_CLOUD_PLAN,
    ALETHEIA_INIT_PROJECT_ID: process.env.ALETHEIA_INIT_PROJECT_ID,
    ALETHEIA_INIT_PROJECT_NAME: process.env.ALETHEIA_INIT_PROJECT_NAME,
    ALETHEIA_INIT_PROJECT_RETENTION:
      process.env.ALETHEIA_INIT_PROJECT_RETENTION,
    ALETHEIA_INIT_PROJECT_PUBLIC_KEY:
      process.env.ALETHEIA_INIT_PROJECT_PUBLIC_KEY,
    ALETHEIA_INIT_PROJECT_SECRET_KEY:
      process.env.ALETHEIA_INIT_PROJECT_SECRET_KEY,
    ALETHEIA_INIT_USER_EMAIL: process.env.ALETHEIA_INIT_USER_EMAIL,
    ALETHEIA_INIT_USER_NAME: process.env.ALETHEIA_INIT_USER_NAME,
    ALETHEIA_INIT_USER_PASSWORD: process.env.ALETHEIA_INIT_USER_PASSWORD,
    NEXT_PUBLIC_BASE_PATH: process.env.NEXT_PUBLIC_BASE_PATH,
    ALETHEIA_MAX_HISTORIC_EVAL_CREATION_LIMIT:
      process.env.ALETHEIA_MAX_HISTORIC_EVAL_CREATION_LIMIT,
    SLACK_CLIENT_ID: process.env.SLACK_CLIENT_ID,
    SLACK_CLIENT_SECRET: process.env.SLACK_CLIENT_SECRET,
    SLACK_STATE_SECRET: process.env.SLACK_STATE_SECRET,

    // AWS Bedrock for aletheia native AI feature such as natural language filters
    ALETHEIA_AWS_BEDROCK_MODEL: process.env.ALETHEIA_AWS_BEDROCK_MODEL,

    // Aletheia Tracing AI Features
    ALETHEIA_AI_FEATURES_HOST: process.env.ALETHEIA_AI_FEATURES_HOST,

    // Api Performance Flags
    ALETHEIA_SKIP_FINAL_FOR_OTEL_PROJECTS:
      process.env.ALETHEIA_SKIP_FINAL_FOR_OTEL_PROJECTS,

    // Natural Language Filters
    ALETHEIA_AI_FEATURES_PUBLIC_KEY:
      process.env.ALETHEIA_AI_FEATURES_PUBLIC_KEY,
    ALETHEIA_AI_FEATURES_SECRET_KEY:
      process.env.ALETHEIA_AI_FEATURES_SECRET_KEY,
    ALETHEIA_AI_FEATURES_PROJECT_ID:
      process.env.ALETHEIA_AI_FEATURES_PROJECT_ID,
    // API Traces endpoint controls
    ALETHEIA_API_TRACES_DEFAULT_DATE_RANGE_DAYS:
      process.env.ALETHEIA_API_TRACES_DEFAULT_DATE_RANGE_DAYS,
    ALETHEIA_API_TRACES_REJECT_NO_DATE_RANGE:
      process.env.ALETHEIA_API_TRACES_REJECT_NO_DATE_RANGE,
    ALETHEIA_API_TRACES_DEFAULT_FIELDS:
      process.env.ALETHEIA_API_TRACES_DEFAULT_FIELDS,
    ALETHEIA_API_TRACEBYID_DEFAULT_FIELDS:
      process.env.ALETHEIA_API_TRACEBYID_DEFAULT_FIELDS,
    ALETHEIA_MIGRATION_V4_ALLOW_PREVIEW_OPT_IN:
      process.env.ALETHEIA_MIGRATION_V4_ALLOW_PREVIEW_OPT_IN,
    ALETHEIA_MIGRATION_V4_WRITE_MODE:
      process.env.ALETHEIA_MIGRATION_V4_WRITE_MODE,
    // Legacy tracing search controls
    ALETHEIA_DISABLE_LEGACY_TRACING_IO_SEARCH:
      process.env.ALETHEIA_DISABLE_LEGACY_TRACING_IO_SEARCH,
    ALETHEIA_OBSERVATIONS_V2_SUBQUERY_REWRITE:
      process.env.ALETHEIA_OBSERVATIONS_V2_SUBQUERY_REWRITE,
    ALETHEIA_OBSERVATIONS_V2_SHADOW_QUERY:
      process.env.ALETHEIA_OBSERVATIONS_V2_SHADOW_QUERY,
    ALETHEIA_OBSERVATIONS_V2_SHADOW_QUERY_SAMPLE_RATE:
      process.env.ALETHEIA_OBSERVATIONS_V2_SHADOW_QUERY_SAMPLE_RATE,
    ALETHEIA_BLOCKED_USERIDS_CHATCOMPLETION:
      process.env.ALETHEIA_BLOCKED_USERIDS_CHATCOMPLETION,
  },
