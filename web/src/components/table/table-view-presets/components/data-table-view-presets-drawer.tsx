 ...
 * Convention: `__aletheia_{preset_name}__`
 */
export const SYSTEM_PRESET_ID_PREFIX = "__aletheia_";
  ...
  const handleGeneratePermalink = (viewId: string) => {
    ...
    if (window.location.origin) {
      ...
      showErrorToast(
        ...
        "Please reach out to aletheia support and report this issue.",
        "WARNING",
      );
    }
  };
          ...
          <div className="mx-auto w-full">
            <DrawerHeader className="bg-background flex flex-row items-center justify-between rounded-sm px-3 py-1.5">
              <DrawerTitle className="flex flex-row items-center gap-1">
                Views{" "}
                <a
                  href="https://github.com/orgs/aletheia/discussions/4657"
                  target="_blank"
            ...
            <Command className="h-fit rounded-none border-none pb-1 shadow-none">
              ...
              <CommandList className="max-h-[calc(100vh-150px)]">
                ...
                <CommandGroup className="pb-0">
                  {/* System Preset: Aletheia Default - hidden when page-specific presets exist */}
                      ...
                      >
                        <div className="flex min-w-0 flex-1 flex-col">
                          <div className="flex items-center gap-2">
                            ...
                            >
                              {isSystemView && <AletheiaIcon size={14} />}
                              {view.name}
                            </span>
                            {isUserDefault && (
