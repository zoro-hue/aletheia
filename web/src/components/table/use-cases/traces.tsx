...
import { type ScoreAggregate } from "@aletheia/shared";
...
export default function TracesTable({
  ...
  const columns: AletheiaColumnDef<TracesTableRow>[] = [
    ...(hideControls
      ? []
      : ([
          selectActionColumn,
        ...
        ] satisfies AletheiaColumnDef<TracesTableRow>[])),
    {
      ...
      headerTooltip: {
        description: (
          <>
            ...
            <a
              href="https://aletheia.com/docs/observability/features/tags"
              target="_blank"
      ...
      headerTooltip: {
        description: (
          <>
            ...
            <a
              href="https://aletheia.com/docs/observability/features/metadata"
              target="_blank"
              rel="noopener noreferrer"
              className="decoration-primary/30 hover:decoration-primary underline"
              onClick={(e) => e.stopPropagation()}
      ...
      headerTooltip: {
        description: (
          <>
            ...
            <a
              href="https://aletheia.com/docs/observability/features/sessions"
              target="_blank"
              rel="noopener noreferrer"
              className="decoration-primary/30 hover:decoration-primary underline"
              onClick={(e) => e.stopPropagation()}
      ...
      headerTooltip: {
        description: (
          <>
            ...
            user tracking{" "}
            <a
              href="https://aletheia.com/docs/observability/features/users"
              target="_blank"
              rel="noopener noreferrer"
              className="decoration-primary/30 hover:decoration-primary underline"
              onClick={(e) => e.stopPropagation()}
      ...
      headerTooltip: {
        description: (
          <>
            ...
            <a
              href="https://aletheia.com/docs/observability/features/releases-and-versioning"
              target="_blank"
              rel="noopener noreferrer"
              className="decoration-primary/30 hover:decoration-primary underline"
              onClick={(e) => e.stopPropagation()}
