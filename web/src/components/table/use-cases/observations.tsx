...
export default function ObservationsTable({
  ...
  const columns: AletheiaColumnDef<ObservationsTableRow>[] = [
    ...
    },
    {
      ...
      headerTooltip: {
        ...
        href: "https://aletheia.com/docs/observability/features/log-levels",
      },
      enableHiding: true,
      cell({ row }) {
    ...
    },
    {
      ...
      header: "Prompt",
      headerTooltip: {
        description: "Link to prompt version in Aletheia prompt management.",
        href: "https://aletheia.com/docs/prompt-management/get-started",
      },
      size: 200,
      enableHiding: true,
      enableSorting,
    ...
    },
    {
      ...
      headerTooltip: {
        ...
        href: "https://aletheia.com/docs/experimentation",
      },
      enableHiding: true,
      enableSorting,
      defaultHidden: true,
    },
    {
      ...
      ] satisfies AletheiaColumnDef<ObservationsTableRow>[],
    },
    {
      accessorKey: "cost",
      header: "Cost",
