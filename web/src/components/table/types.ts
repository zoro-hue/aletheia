...
export type AletheiaColumnDef<
  TData extends RowData,
  TValue = unknown,
> = ColumnDef<TData, TValue> & {
  // Enforce aletheia columns to be of type 'AccessorKeyColumnDefBase' with 'accessorKey' property of type string
  accessorKey: string;
  // Enforce aletheia group columns to have children of type 'AletheiaColumnDef'
