...
import { AletheiaLogo } from "@/src/components/AletheiaLogo";
      ...
      <SidebarGroupContent>
        <SidebarMenu>
          <SidebarMenuItem>
            ...
            >
              <Link
                href="https://aletheia.com/docs/demo"
                target="_blank"
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild tooltip="Your Aletheia Organizations">
              <Link href="/">
                <Grid2X2 className="h-4 w-4" />
                <span>Your Aletheia Orgs</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
