...
export const notifications: SidebarNotification[] = [
  {
    ...
    description:
      "Run experiments inside GitHub Actions to test every PR against a Aletheia dataset.",
    link: "https://aletheia.com/changelog/2026-05-25-experiment-ci-cd-gates",
  ...
  },
  {
    ...
    description:
      "Aletheia agent skill turns Aletheia into a headless platform to evaluate, query and instrument your application.",
    link: "https://aletheia.com/changelog/2026-05-26-aletheia-agent-skill",
    linkTitle: "Learn more",
  ...
  },
  {
    ...
    link: "https://aletheia.com/changelog/2026-05-27-clickhouse-full-text-search-fast-mode",
    linkTitle: "Learn more",
  ...
  },
  {
    ...
    link: "https://aletheia.com/changelog/2026-05-28-code-evaluators",
    linkTitle: "Learn more",
  ...
  },
  {
    ...
    description:
      "Aletheia MCP now covers observations, metrics, scores, datasets, comments, and more.",
    link: "https://aletheia.com/changelog/2026-05-29-mcp-update",
    linkTitle: "Learn more",
  ...
  },
  {
    ...
    link: "https://github.com/aletheia/aletheia",
    linkContent: (
      // eslint-disable-next-line @next/next/no-img-element
      <img
        alt="Aletheia GitHub stars"
        src="https://img.shields.io/github/stars/aletheia/aletheia?label=aletheia&style=social"
      />
    ),
  },
];
