...
import { type TraceDomain, type ScoreDomain } from "@aletheia/shared";
...
import { CausalAttributionPanel } from "@/src/components/trace/components/CausalAttributionPanel";
...
export function TraceDetailView({
  ...
  const handleTabChange = (value: string) => {
    ...
    if (value === "preview" || value === "log" || value === "scores") {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      ...
      >
        ...
        {showTabsBar && (
          <TooltipProvider>
            <TabsBarList>
              ...
              <TabsBarTrigger value="reliability">RCA / Attribution</TabsBarTrigger>
        ...
        {/* RCA / Attribution tab content */}
        <TabsBarContent
          value="reliability"
          className="mt-0 flex max-h-full min-h-0 w-full flex-1 overflow-hidden"
        >
          <CausalAttributionPanel projectId={projectId} traceId={trace.id} />
        </TabsBarContent>
      </TabsBar>
    </div>
  );
