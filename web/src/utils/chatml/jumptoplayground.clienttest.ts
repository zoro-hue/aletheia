// Mock the problematic @aletheia/shared import before importing our functions
vi.mock("@aletheia/shared", async () => {
  const actual = await vi.importActual("@aletheia/shared");
