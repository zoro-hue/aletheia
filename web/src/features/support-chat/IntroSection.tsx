...
export function IntroSection({ onStartForm }: { onStartForm: () => void }) {
  ...
  //       The issue was that on global routes e.g., https://aletheia.com/setup, the entitlement
  ...
  const hasInAppSupportEntitlement = !!isAletheiaCloud;
  const plan = usePlan();
    ...
    <div className="mt-1 flex flex-col gap-6">
      <div className="flex flex-col gap-3">
        ...
        <RainbowButton asChild>
          <a
            href="https://aletheia.com/docs/ask-ai"
            target="_blank"
            rel="noopener"
          >
            Chat with AI
      ...
      <div className="flex flex-col gap-3">
        ...
        <Button asChild variant="outline">
          <a
            href={
              uiCustomization?.documentationHref ?? "https://aletheia.com/docs"
            }
            target="_blank"
            rel="noopener"
          >
          ...
          <div className="flex flex-col gap-3">
            ...
            {!uiCustomization?.supportHref && (
              <>
                ...
                <Button variant="outline" asChild>
                  <a
                    href="https://aletheia.com/issues"
                    target="_blank"
                    rel="noopener"
                  >
                    Report a bug
      ...
      {supportType === "community" && (
        <>
          <div className="flex flex-col gap-3">
            ...
            <Button variant="outline" asChild>
              <a
                href="https://aletheia.com/gh-support"
                target="_blank"
                rel="noopener"
              >
      ...
      {supportType !== "custom" && (
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            Join the conversation and connect with the Aletheia community.
          </p>
          <div className="mt-3 grid grid-cols-1 gap-2">
            ...
            <Button asChild variant="ghost" className="justify-start px-1.5">
              <a
                href="https://aletheia.com/discord"
                target="_blank"
                rel="noopener"
            ...
            {showStatusPageLink && (
              <Button asChild variant="ghost" className="justify-start px-1.5">
                <a
                  href="https://status.aletheia.com"
                  target="_blank"
                  rel="noopener"
                  className="flex items-center"
                >
