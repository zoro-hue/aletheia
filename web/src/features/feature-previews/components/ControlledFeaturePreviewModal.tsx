...
function getInAppAgentWarningReason({
  ...
  if (!hasInAppAgentEntitlement) {
    return "The Aletheia Assistant preview is not available on your current plan. You can enable the preview, but the Assistant button will not be shown here.";
  }
