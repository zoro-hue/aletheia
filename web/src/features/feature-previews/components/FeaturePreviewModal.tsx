...
const PREVIEW_REGISTRY: PreviewRegistryItem[] = [
  {
    flag: "inAppAgent",
    title: "Aletheia Assistant",
    sidebarLabel: "Aletheia Assistant",
    description:
      "Explore project data, understand connected Aletheia resources, and get practical help while investigating your application.",
    details:
      "This experimental preview can help you inspect traces and observations, look up related scores or prompts, and answer practical questions while you work in a project. Today, it is most useful for exploring project data and understanding how different Aletheia resources connect. Over time, the goal is to help teams generate insights faster and improve their agentic products with less manual investigation.",
    feedbackUrl: "https://github.com/orgs/aletheia/discussions/14196",
    illustration: {
      light: inAppAgentLightIllustration,
      dark: inAppAgentDarkIllustration,
      alt: "Aletheia Assistant connects traces, scores, and prompts to answer project questions.",
    },
  },
