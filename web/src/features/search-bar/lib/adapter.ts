// Editor AST → flat Aletheia filter contract.
//
...
import { type FilterState, type TracingSearchType } from "@aletheia/shared";
...
/** AST string op -> Aletheia string filter operator (positive polarity). */
