...
export function ResetPasswordPage({
  ...
  async function onSubmit(values: z.infer<typeof resetPasswordSchema>) {
    ...
    await mutResetPassword
      ...
      .then(() => {
        ...
        setTimeout(() => {
          const target =
            isSetMode && isAletheiaCloud && region !== "DEV"
              ? "/onboarding"
              : "/";
          router.push(target);
          setIsSuccess(false);
    ...
    return (
      <ErrorPage
        ...
        additionalButton={{
          ...
          href: "https://aletheia.com/self-hosting/security/authentication-and-sso#auth-email-password",
        }}
      />
    );
  ...
  return (
    <>
      <Head>
        <title>{pageTitle} | Aletheia</title>
      </Head>
