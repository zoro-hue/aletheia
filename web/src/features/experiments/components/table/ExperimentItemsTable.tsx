...
export default function ExperimentItemsTable({
  ...
  const buildExperimentScoreColumns = useCallback(
    (
      scoreColumns: AletheiaColumnDef<ExperimentItemData>[],
      scoreField: "observationScores" | "traceScores",
    ): AletheiaColumnDef<ExperimentItemsTableRow>[] =>
      ...
      })) as AletheiaColumnDef<ExperimentItemsTableRow>[],
  ...
  const columns: AletheiaColumnDef<ExperimentItemsTableRow>[] = [
