...
export function ExperimentOverviewPanel({
  ...
  const pullRequestUrl = metadata["aletheia.pr_url"];
  const githubJobUrl = metadata["aletheia.github_job_url"];
  ...
  if (safePullRequestUrl) delete additionalMetadata["aletheia.pr_url"];
  if (safeGithubJobUrl) delete additionalMetadata["aletheia.github_job_url"];
