import { ObservationType } from "@aletheia/shared";
import {
...
function addAletheiaSystemNodes(
  data: AgentGraphDataResponse[],
): AgentGraphDataResponse[] {
...
export function buildStepData(
  ...
  // Add Aletheia system nodes to make it consistent with LangGraph path
  const dataWithSystemNodes = addAletheiaSystemNodes(dataWithSteps);
