...
import { type DashboardWidgetChartType } from "@aletheia/shared/src/db";
import { type metricAggregations } from "@aletheia/shared/query";
...
export function DashboardWidgetTable() {
  ...
  ] as AletheiaColumnDef<WidgetTableRow>[];
