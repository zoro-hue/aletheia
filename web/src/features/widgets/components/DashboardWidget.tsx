...
import { type FilterState, type OrderByState } from "@aletheia/shared";
...
export function DashboardWidget({
  ...
  dashboardOwner: "ALETHEIA" | "PROJECT";
  schedulerId?: string;
}) {
    ...
    >
      <div className="flex items-center justify-between">
        <span className="truncate font-medium" title={widget.data.name}>
          {widget.data.name}{" "}
          {dashboardOwner === "PROJECT" && widget.data.owner === "ALETHEIA"
            ? " ( 🪢 )"
            : null}
        </span>
