...
export async function telemetry() {
  try {
    ...
    // Do not run in Aletheia cloud, separate telemetry is used
    if (env.NEXT_PUBLIC_ALETHEIA_CLOUD_REGION !== undefined) return;
  ...
  try {
    ...
    posthog.capture({
      ...
      properties: {
        ...
        eeLicenseKey: env.ALETHEIA_EE_LICENSE_KEY,
