...
const DEFAULT_CLICKHOUSE_RESOURCE_ERROR_MESSAGE = [
  ...
  "See https://aletheia.com/docs/api-and-data-platform/features/public-api for more details.",
].join("\n");
...
export const LEGACY_PUBLIC_API_OBSERVATIONS_CLICKHOUSE_RESOURCE_ERROR_MESSAGE =
  [
    ...
    "This applies to Aletheia Cloud only until v4 is released in OSS.",
    "Docs: https://aletheia.com/docs/api-and-data-platform/features/observations-api",
  ].join("\n");
...
export const LEGACY_PUBLIC_API_METRICS_CLICKHOUSE_RESOURCE_ERROR_MESSAGE = [
  ...
  "This applies to Aletheia Cloud only until v4 is released in OSS.",
  "Docs: https://aletheia.com/docs/metrics/features/metrics-api",
].join("\n");
