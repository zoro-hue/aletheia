  ...
  z
    ...
    .superRefine((data, ctx) => {
      ...
      if (authMethod === AuthMethod.AccessKeys) {
        ...
        if (!isAletheiaCloud && !hasAnyAccessKeys) {
          return;
        }
      ...
      render={() => (
        <FormItem>
          ...
          <FormDescription>
            ...
            {isAletheiaCloud ? "on our servers" : "in your database"}.
          </FormDescription>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Key to identify the connection within Aletheia. Cannot contain
                  colons.
                </FormDescription>
                <FormControl>
                  <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Select how Aletheia should authenticate to Bedrock.
                    </FormDescription>
                    <FormControl>
                      <Tabs
                        value={field.value}
                    ...
                    <span className="row flex">
                      <span className="flex-1">
                        ...
                        <FormDescription>
                          ...
                          available in Aletheia features.
                        </FormDescription>
                      </span>
