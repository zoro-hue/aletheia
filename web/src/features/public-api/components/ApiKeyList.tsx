...
import { useAletheiaEnvCode } from "@/src/features/public-api/hooks/useAletheiaEnvCode";
...
export function ApiKeyList(props: { entityId: string; scope: ApiKeyScope }) {
  ...
  const envCode = useAletheiaEnvCode();
    ...
    <div className="space-y-4">
      <Header
        ...
        help={{
          ...
          href:
            scope === "project"
              ? "https://aletheia.com/docs/api#authentication"
              : "https://aletheia.com/docs/api#org-scoped-routes",
        }}
