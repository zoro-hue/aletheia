...
import { prisma, type Prompt } from "@aletheia/shared/src/db";
import { PromptService, redis } from "@aletheia/shared/src/server";
...
export const deletePrompt = async (params: DeletePromptParams) => {
  ...
  if (promptVersions.length === 0) {
    throw new AletheiaNotFoundError("Prompt not found");
  }
