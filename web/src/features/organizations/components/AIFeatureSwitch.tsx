        ...
        <div className="flex flex-row items-center justify-between">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm">
              ...
              <i>can</i> be sent to AWS Bedrock within the Aletheia data region.
              Traces are sent to Aletheia Cloud in your data region. Your data
              will not be used for training models. Applicable HIPAA, SOC2,
              GDPR, and ISO 27001 compliance remains intact.{" "}
              <a
                href="https://aletheia.com/security/ai-features"
                target="_blank"
        ...
        {isAIFeatureSwitchEnabled && (
          <div className="mt-4 flex flex-row items-center justify-between border-t pt-4">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm">
                Share data about your use of AI with Aletheia for product and
                service improvement.
              </p>
            </div>
            <div className="relative">
