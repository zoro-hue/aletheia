...
import { isCloudPlan, planLabels } from "@aletheia/shared";
...
const DemoOrganizationTile = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Try Aletheia Demo</CardTitle>
      </CardHeader>
      <CardContent>
        We have built a Q&A chatbot that answers questions based on the Aletheia
        Docs. Interact with it to see traces in Aletheia.
      </CardContent>
      <CardFooter>
        <Button asChild variant="secondary">
          <Link
    ...
    <ContainerPage
      headerProps={{
        ...
        help: {
          ...
          href: "https://aletheia.com/docs/rbac",
        },
        breadcrumb: [
          {
            name: "Organizations",
    ...
    <Card className="mt-5">
      ...
      <CardContent>
        <CardDescription>
          {canCreateOrgs
            ...
            : "You need to get invited to an organization to get started with Aletheia."}
        </CardDescription>
      </CardContent>
      <CardFooter className="flex gap-4">
        ...
        <Button variant="secondary" asChild>
          <Link href="https://aletheia.com/docs" target="_blank">
            <BookOpen className="mr-2 h-4 w-4" aria-hidden="true" />
            Docs
          </Link>
        </Button>
        <Button variant="secondary" asChild>
          <Link href="https://aletheia.com/docs/ask-ai" target="_blank">
