import { CommentObjectType, publicApiPaginationZod } from "@aletheia/shared";
import { z } from "zod";
...
export const [listCommentsTool, handleListComments] = defineTool({
  name: "listComments",
  description:
    "List comments in the current Aletheia project, optionally filtered by object or author.",
