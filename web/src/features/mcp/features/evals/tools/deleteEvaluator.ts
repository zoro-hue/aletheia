...
export const [deleteEvaluatorTool, handleDeleteEvaluator] = defineTool({
  ...
  description:
    "Delete a project evaluator by id, including all of its versions. Fails while evaluation rules still reference the evaluator; delete those first. Aletheia-managed evaluators cannot be deleted. This cannot be undone.",
