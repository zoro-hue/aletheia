...
import { type ColumnDefinition } from "@aletheia/shared";
import { type FilterState } from "@aletheia/shared";
import { type EnrichedDatasetRunItem } from "@aletheia/shared/src/server";
...
export const constructDatasetRunAggregateColumns = ({
  ...
  getFiltersForRun: (runId: string) => FilterState;
  serverScoreColumns?: ScoreColumn[];
}): AletheiaColumnDef<DatasetCompareRunRowData>[] => {
