...
A Aletheia score returned by a TypeScript evaluator. The contract is shown at the top of the editor and is locked.`;
...
A Aletheia score returned by a Python evaluator.`;

export const TYPESCRIPT_CODE_EVAL_HOVER_DOCS = {
  evaluate: `function evaluate(ctx: EvaluationContext): EvaluationResult

The TypeScript function Aletheia executes for each matched target observation.`,
  ctx: `parameter ctx: EvaluationContext

The TypeScript value Aletheia passes to evaluate.`,
...
The data Aletheia passes to a TypeScript evaluator. The definition is locked at the top of the editor.`,
...
One or more Aletheia scores to create for the target observation.`,
  dataType: `property Score.dataType: "NUMERIC" | "BOOLEAN" | "CATEGORICAL" | "TEXT"

The Aletheia score data type.`,
...
The Python function Aletheia executes for each matched target observation.`,
  ctx: `parameter ctx: EvaluationContext

The Python dataclass value Aletheia passes to evaluate.`,
  Any: `typing.Any
...
The data Aletheia passes to a Python evaluator.`,
...
The Aletheia score data type. Use NUMERIC, BOOLEAN, CATEGORICAL, or TEXT.`,
