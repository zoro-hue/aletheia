...
export default function EvalsTemplateTable({
  ...
  ] as AletheiaColumnDef<EvalsTemplateRow>[];
        ...
        >
          ...
          <EvalTemplateForm
            ...
            onBeforeSubmit={(template) => {
              // Only show reference dialog for Aletheia maintained templates
              if (
                cloneTemplateId &&
                cloneTemplate.data &&
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              Aletheia evaluator to reference your new project-level version?
              <br />
              <br />
