...
import { type ModelParams, ZodModelConfig } from "@aletheia/shared";
  ...
  return (
    <div className={props.useDialog ? "max-w-6xl" : "w-full"}>
      <InnerEvalTemplateForm
        ...
        preFilledFormValues={
          // if a aletheia template is selected, use that, else use the existing template
          // no aletheia template is selected if there is already an existing template
...
export const InnerEvalTemplateForm = (props: {
  projectId: string;
  useDialog: boolean;
  // pre-filled values from aletheia-defined template or template from db
  preFilledFormValues?: EvalTemplateFormPreFill;
  templateTypeSelectorMode?: EvalTemplateTypeSelectorMode;
  ...
  // either form update or from aletheia-generated template
  const {
    modelParams,
    setModelParams,
                        ...
                        <ManageDefaultEvalModel
                          ...
                          setUpMessage={
                            <>
                              ...
                              <a
                                href="https://aletheia.com/docs/evaluation/evaluation-methods/llm-as-a-judge#how-llm-as-a-judge-works"
                                target="_blank"
      ...
      <AlertDescription>
        <div className="flex flex-col gap-1">
          ...
          <span className="text-foreground text-sm">
            ...
            <a
              href="https://aletheia.com/docs/observability/sdk/upgrade-path"
              target="_blank"
              rel="noopener noreferrer"
