...
import { EvalTargetObject, EvalTargetObjectSchema } from "@aletheia/shared";
        ...
        alert: {
          ...
          content: (
            <>
              ...
              <a
                href="https://aletheia.com/integrations/native/opentelemetry#propagating-attributes"
                target="_blank"
              ...
              <div className="flex h-[30dvh] flex-col items-center justify-center gap-2 border-t p-4 text-center">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-muted-foreground max-w-md text-sm">
                    We did not find any data ingested with aletheia
...
export const InnerEvaluatorForm = (props: {
  ...
  useEffect(() => {
    ...
    if (mapping.length === 0 && props.evalTemplate.vars.length > 0) {
      ...
      form.setValue(
        ...
        props.evalTemplate.vars.map((v) => ({
          templateVariable: v,
          aletheiaObject: isLegacyEvalTarget(target)
            ? ("trace" as const)
            : undefined,
  ...
  function onSubmit(values: z.infer<typeof evalConfigFormSchema>) {
    ...
    if (
      ...
      values.mapping.some(
        (m) => m.aletheiaObject && m.aletheiaObject !== "trace",
      )
    ) {
          ...
          <DialogFooter>
            ...
            <Button
              onClick={() => {
                ...
                const aletheiaObject: AletheiaObject = "trace";
