                        ...
                        <Card className="flex flex-col gap-2 p-4" key={index}>
                          ...
                          >
                            ...
                            <DocPopup
                              ...
                              href={
                                "https://aletheia.com/docs/evaluation/evaluation-methods/llm-as-a-judge"
                              }
                            />
                          </div>
                          <FormField
                            control={form.control}
                            key={`${mappingField.id}-aletheiaObject`}
                            name={`mapping.${index}.aletheiaObject`}
                            render={({ field }) => (
                              <div className="flex items-center gap-2">
                                <VariableMappingDescription
                                  title="Object"
                                  description={
                                    "Aletheia object to retrieve the data from."
                                  }
                                  href={
                                    "https://aletheia.com/docs/evaluation/evaluation-methods/llm-as-a-judge"
                                  }
                          ...
                          {!isTraceOrDatasetObject(
                            form.watch(`mapping.${index}.aletheiaObject`) ?? "",
                          ) ? (
                            <FormField
                              control={form.control}
                                ...
                                return (
                                  <div className="flex items-center gap-2">
                                    <VariableMappingDescription
                                      title={"Object Name"}
                                      description={
                                        "Name of the Aletheia object to retrieve the data from."
                                      }
                                      href={
                                        "https://aletheia.com/docs/evaluation/evaluation-methods/llm-as-a-judge"
                                      }
                                        ...
                                        {isCustomOption ? (
                                          <div className="flex flex-col gap-2">
                                            ...
                                            <Input
                                              ...
                                              placeholder="Enter aletheia object name"
                                              disabled={disabled}
                                            />
                                          </div>
                                        ) : (
                            ...
                            render={({ field }) => (
                              <div className="flex items-center gap-2">
                                <VariableMappingDescription
                                  title={"Object Field"}
                                  description={
                                    "Field on the Aletheia object to insert into the template."
                                  }
                                  href={
                                    "https://aletheia.com/docs/evaluation/evaluation-methods/llm-as-a-judge"
                                  }
                          ...
                          {hideAdvancedSettings && (
                            <div className="flex items-center gap-2">
                              <VariableMappingDescription
                                ...
                                href="https://aletheia.com/docs/evaluation/evaluation-methods/llm-as-a-judge"
                              />
                              <div className="w-2/3">
                                <Input
                                  value={
