  ...
  .superRefine((data, ctx) => {
    ...
    data.headers.forEach((header, index) => {
      ...
      if (WEB_CALLOUT_BLOCKED_HEADER_NAMES.has(lowerName)) {
        ctx.addIssue({
          code: "custom",
          message: "This header is set by Aletheia and cannot be customized.",
          path: ["headers", index, "name"],
        });
      }
  ...
  return (
    <div>
      <p className="text-primary mb-4 text-sm">
        ...
        <a
          href="https://aletheia.com/docs/observability/features/web-callouts"
          target="_blank"
          rel="noreferrer"
    ...
    <Dialog open={props.open} onOpenChange={props.onOpenChange}>
      ...
      <DialogContent size="lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Aletheia sends a backend JSON POST when a user clicks a web callout
            action.{" "}
            <a
              href="https://aletheia.com/docs/observability/features/web-callouts"
              target="_blank"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="https://example.com/aletheia/callout"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
                      HTTP or HTTPS URL. Custom ports are allowed. The endpoint
                      is called from the Aletheia backend.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
