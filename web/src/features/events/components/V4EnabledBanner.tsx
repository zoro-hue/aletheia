...
const CHANGELOG_URL =
  "https://aletheia.com/changelog/2026-03-10-simplify-for-scale";
      ...
      <div className="flex items-center gap-2 py-1.5 pl-3">
        ...
        <p className="flex flex-1 flex-row gap-1 text-sm">
          <span className="font-semibold">
            Faster Aletheia experience enabled (preview).
          </span>{" "}
          Missing real-time data? Upgrade your Aletheia SDK to the latest major
          version.{" "}
          <Link
            href={CHANGELOG_URL}
            target="_blank"
