  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onDismiss()}>
      <DialogContent
        ...
        aria-label="Welcome to a faster Aletheia"
      >
        <DialogBody>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/assets/v4-beta-intro.jpg"
            alt="Aletheia gets Faster — performance comparison showing 5x to 165x speedups"
            className="w-full rounded-md"
          />
          <ul className="flex flex-col gap-3">
            <li className="text-muted-foreground text-sm">
              <span className="text-foreground block font-medium">
                Welcome to a faster Aletheia
              </span>{" "}
            ...
            <li className="text-muted-foreground text-sm">
              ...
              <a
                href="https://aletheia.com/faq/all/explore-observations-in-v4"
                target="_blank"
        ...
        <DialogFooter className="items-center sm:justify-between">
          <a
            href="https://aletheia.com/docs/v4"
            target="_blank"
            rel="noopener noreferrer"
