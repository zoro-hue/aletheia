...
import { validateFieldAgainstSchema } from "@aletheia/shared";

process.env.ALETHEIA_DATASET_SERVICE_READ_FROM_VERSIONED_IMPLEMENTATION =
  "true";
process.env.ALETHEIA_DATASET_SERVICE_WRITE_TO_VERSIONED_IMPLEMENTATION = "true";
