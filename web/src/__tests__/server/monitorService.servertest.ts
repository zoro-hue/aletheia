...
describe("MonitorService (integration)", () => {
  ...
  describe("update", () => {
    ...
    it("throws AletheiaNotFoundError when the monitor does not exist", async () => {
      await expect(
        MonitorService.update(editor, {
          ...baseMonitorInput(projectId),
          id: "mon_missing",
        }),
      ).rejects.toBeInstanceOf(AletheiaNotFoundError);
    });
  ...
  describe("getById / list / delete", () => {
    ...
    it("throws AletheiaNotFoundError when fetching from a different project", async () => {
      const created = await MonitorService.create(
        creator,
        baseMonitorInput(projectId),
      );
    ...
    it("deletes a monitor and getById then throws AletheiaNotFoundError", async () => {
      const created = await MonitorService.create(
        creator,
        baseMonitorInput(projectId),
      );
