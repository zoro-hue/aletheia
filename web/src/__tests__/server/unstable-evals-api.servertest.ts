...
import { createNumericEvalOutputDefinition } from "@aletheia/shared";
...
import { LLMAdapter } from "@aletheia/shared";
...
describe("/api/public/unstable evaluators API", () => {
  ...
  it("rejects deletion of aletheia-managed evaluators", async () => {
