...
describe("MCP Error Formatting", () => {
  describe("formatErrorForUser", () => {
    ...
    describe("Aletheia standard errors", () => {
      ...
      it("should format AletheiaNotFoundError with original message", () => {
        const error = new AletheiaNotFoundError("Prompt not found: chatbot");
        const mcpError = formatErrorForUser(error);
  ...
  describe("Error priority and categorization", () => {
    it("should categorize user-fixable errors as InvalidRequest", () => {
      const userErrors = [
        ...
        new AletheiaNotFoundError("Not found"),
