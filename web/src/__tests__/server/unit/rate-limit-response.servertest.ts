...
import type { RateLimitResult } from "@aletheia/shared";
...
vi.mock("@/src/env.mjs", () => ({
  env: {
    ...
    ALETHEIA_RATE_LIMITS_ENABLED: "true",
  },
}));

vi.mock("@aletheia/shared/src/env", () => ({
  env: {
...
describe("sendRateLimitResponse", () => {
  const upgradePath = {
    ...
    docsUrl:
      "https://aletheia.com/docs/api-and-data-platform/features/observations-api",
  };
