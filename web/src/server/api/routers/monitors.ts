...
/** monitorsProcedure protects every monitors route behind a Aletheia Cloud check. */
const monitorsProcedure = protectedProjectProcedure.use(requireAletheiaCloud);
