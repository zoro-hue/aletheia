        ...
        spans: [
          {
            ...
            attributes: [
              ...
              ...params.metadataAttrs.map((attr) => ({
                key: `aletheia.observation.metadata.${attr.key}`,
                value: attr.value,
              })),
            ],
            status: {},
            ...
            spans: [
              {
                ...
                attributes: [
                  ...
                  {
                    key: "aletheia.experiment.metadata",
                    value: {
                  ...
                  {
                    key: "aletheia.experiment.metadata.override",
                    value: { stringValue: "flattened-value" },
                  },
                  {
                    key: "aletheia.experiment.metadata.region",
                  ...
                  {
                    key: "aletheia.experiment.item.root_observation_id",
                    value: { stringValue: "842d3593cd7c818e" },
                  },
                  {
                    key: "aletheia.experiment.item.metadata",
                    value: {
                      stringValue: JSON.stringify({
                        legacy: true,
                  ...
                  {
                    key: "aletheia.experiment.item.metadata.continent",
                    value: { stringValue: "Europe" },
                  },
                  {
                    key: "aletheia.experiment.item.metadata.position",
                    value: { intValue: 3 },
                  },
                  {
                    key: "aletheia.observation.metadata.continent",
