import { logger, MonitorQueue, QueueJobs } from "@aletheia/shared/src/server";
import { MonitorScheduler } from "@aletheia/shared/monitors/server";
...
export class MonitorRunner extends PeriodicExclusiveRunner {
  ...
  constructor(schedulerId: number, totalSchedulers: number) {
    super({
      ...
      lockKey: `aletheia:monitor:${schedulerId}`,
      lockTtlSeconds,
    });
