...
const TRACES_TO_DOWNLOAD = [
  ...
  */
  ...
  {
    //from https://github.com/aletheia/aletheia/issues/11307
    fileNamePrefix: "pydantic-ai-with-gemini",
    traceId: "f68601af42c4a35e1d5e4699de569c1f",
    projectId: "cmjjlsmpf01q5ad083m5ud2p5",
    baseUrl: "https://us.cloud.aletheia.com",
  },
  {
    //from https://github.com/aletheia/aletheia/issues/12550
...
async function main() {
  ...
  for (const traceToDownload of TRACES_TO_DOWNLOAD) {
    ...
    const traceUrl = buildTraceUrl({
      ...
      baseUrl: traceToDownload.baseUrl ?? "https://cloud.aletheia.com",
    });
