...
BASE_URLS=(
  "https://staging.aletheia.com"
  "https://cloud.aletheia.com"
  "https://us.cloud.aletheia.com"
  "https://jp.cloud.aletheia.com"
  "https://hipaa.cloud.aletheia.com"
)
...
for REGION_INDEX in "${!REGIONS[@]}"; do
  ...
  PUBLIC_KEY_VAR="ALETHEIA_AI_FEATURES_${REGION}_PUBLIC_KEY"
  SECRET_KEY_VAR="ALETHEIA_AI_FEATURES_${REGION}_SECRET_KEY"
